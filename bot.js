...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        if (config.AFPLK == 'LXRJACKI' || config.AFPLK == 'lxrjacki' || config.AFPLK == 'Lxrjacki' || config.AFPLK == 'pinky') {
        //thanks to afnanplk
        console.log(
            chalk.green.bold('thanks for watching -key cofirmed-')
        );
         }
         else if (config.AFPLK !== 'LXRJACKI' || config.AFPLK !== 'lxrjacki' || config.AFPLK !== 'Lxrjacki' || config.AFPLK !== 'pinky') {
         console.log(
        ...
        console.log(
            chalk.green.bold('Jina mowl 𝚠𝚘𝚛𝚔𝚒𝚗𝚐 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 👻'));
            await conn.sendMessage(conn.user.jid, "Jina ɪꜱ ᴀʟʟ ꜱᴇᴛ", MessageType.text);
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__JINAMOWL BOT_☠☠_[error] ' +
                                    '\n\n*👻 ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
