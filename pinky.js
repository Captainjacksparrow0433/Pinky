...
module.exports = {
 ...
 OA_NAME: process.env.Z_DEP_NAME === undefined ? 'Abin' : process.env.Z_DEP_NAME,
 ...
 OA_REPLY: process.env.Z_DEP_REPLY === undefined ? 'you typed Abin, he is my creator' : process.env.Z_DEP_REPLY,
